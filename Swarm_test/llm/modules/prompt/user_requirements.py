...
tasks = {
    ...
    "formation": "Each robot needs to satisfy three requirements: first, it must enter the target area; second, it must avoid collisions with neighboring robots; and third, it must ensure that its position is very close to the average position of the unoccupied cells."
}
