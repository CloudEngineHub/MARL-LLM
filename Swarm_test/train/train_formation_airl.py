        ...
        if ep_index % 3 == 0:
            for _ in range(20):
                for a_i in range(maddpg.nagents):
                    ...
                    obs_sample, acs_sample, log_pis_sample, _, next_obs_sample, dones_sample = sample
        ...
        for _ in range(20):      
            for a_i in range(maddpg.nagents):
                if len(agent_buffer[a_i]) >= cfg.batch_size:
                    ...
                    # maddpg.update(obs_sample, acs_sample, log_pis_sample, rew_sample, next_obs_sample, dones_sample, a_i, airl, logger=logger)     # parameter update 
