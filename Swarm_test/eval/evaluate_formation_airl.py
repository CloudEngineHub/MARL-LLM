...
def process_shape(shape_index, env, l_cells_input, grid_center_origins_input, binary_images_input, shape_bound_points_origins_input):
    ...
    # env.env.  = np.sqrt(4*env.env.n_g/(env.env.n_a*np.pi)) * env.env.l_cell
...
def run(cfg):
    ...
    curr_run = '2024-11-05-20-01-03_haixing'
    ...
    # run_dir = model_dir / curr_run / 'incremental' / 'model_ep3401.pt'
